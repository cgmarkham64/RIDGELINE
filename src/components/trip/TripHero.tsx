    ...
    <div style={{ height: 240, position: 'relative', overflow: 'hidden', flexShrink: 0 }}>
      ...
      <div
        style={{
          ...
          inset: 0,
          background:
            'linear-gradient(160deg, #1c1308 0%, #2e2618 22%, #3c3c2c 48%, #5a6858 72%, #8a9a88 100%)',
        }}
      />
      ...
      <div
        style={{
          ...
          inset: 0,
          background:
            'linear-gradient(to top, rgba(15,13,11,1) 0%, rgba(15,13,11,0.55) 32%, rgba(15,13,11,0.1) 65%, transparent 100%)',
        }}
      />
      ...
      >
        ...
        <div>
          ...
          <div
            style={{ fontSize: 13, fontWeight: 300, fontStyle: 'italic', color: 'var(--text-mid)' }}
          >
