  ...
  return (
    <aside style={{
      ...
      <div style={{ flex: 1, overflowY: 'auto', minHeight: 0, padding: '8px 0 16px' }}>
        {isLoading && (
          <p style={{ padding: '24px 14px', fontFamily: 'var(--font-mono)', fontSize: 9, color: 'var(--text-dim)', letterSpacing: '0.1em', textTransform: 'uppercase' }}>
            Loading…
          </p>
        )}

        {isError && (
          <p style={{ padding: '24px 14px', fontFamily: 'var(--font-mono)', fontSize: 9, color: 'var(--red)', letterSpacing: '0.1em', textTransform: 'uppercase' }}>
            Could not load trips
          </p>
        )}

        {!isLoading && !isError && sorted.length === 0 && (
          <p style={{ padding: '24px 14px', fontFamily: 'var(--font-mono)', fontSize: 9, color: 'var(--text-dim)', letterSpacing: '0.1em', textTransform: 'uppercase', lineHeight: 1.8 }}>
