...
export const STAGE_SUBS: Record<StageId, string> = {
  ...
  food:    'Calorie targets and meal planning. Resupply pulls from your route waypoints.',
...
export const STAGE_DESCRIPTIONS: Record<StageId, string> = {
  ...
  food:    'Calorie targets and meal planning for each day, resupply logistics, and bear canister selection.',
